...
const Sidebar = ({ isOpen, onToggle, onApiKeyChange }: SidebarProps) => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('/lovable-uploads/e09cbeeb-94c4-482b-911f-a20e759f1822.png')",
      ...
      <div className="h-full w-full bg-black/50 backdrop-blur-sm">
        <nav className="flex h-full w-full flex-col px-3" aria-label="Chat history">
          <div className="flex justify-between flex h-[60px] items-center">
            <button onClick={onToggle} className="h-10 rounded-lg px-2 text-token-text-secondary hover:bg-white/10">
              <Menu className="h-5 w-5" />
            </button>
            <button className="flex items-center gap-2 rounded-lg px-3 py-1 text-sm hover:bg-white/10">
          ...
          <div className="flex-col flex-1 transition-opacity duration-500 relative -mr-2 pr-2 overflow-y-auto">
            {isOpen && (
              <div className="p-2 mb-4 bg-black/30 rounded-lg backdrop-blur-sm">
                ...
                <Input
                  ...
                  className="bg-white/10 border-none placeholder:text-white/50"
                />
              </div>
            )}
            ...
            <div className="pt-0">
              <div className="flex flex-col gap-2 px-2 py-2">
                <div className="group flex h-10 items-center gap-2.5 rounded-lg px-2 hover:bg-white/10 cursor-pointer">
                  <div className="h-6 w-6 flex items-center justify-center">
                    <Globe className="h-4 w-4" />
                  </div>
                  <span className="text-sm">The Pathfinder</span>
                </div>
                <div className="group flex h-10 items-center gap-2.5 rounded-lg px-2 hover:bg-white/10 cursor-pointer">
                  <div className="h-6 w-6 flex items-center justify-center">
                    <Globe className="h-4 w-4" />
                  </div>
                  <span className="text-sm">AI for the Adventurous</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {isOpen && (
            <div className="flex flex-col py-2 border-t border-white/20">
              <button className="group flex gap-2 p-2.5 text-sm items-start hover:bg-white/10 rounded-lg px-2 text-left w-full min-w-[200px]">
                <span className="flex w-full flex-row flex-wrap-reverse justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="line-clamp-1 text-xs text-white/70">More access to the best models</span>
                    </div>
                  </div>
                </span>
              </button>
