...
const ProjectSidebar = ({ isOpen }: ProjectSidebarProps) => {
  ...
  return (
    <div 
      className={`fixed top-[60px] right-0 h-full w-80 bg-chatgpt-main border-l border-white/20 transform transition-transform duration-300 ease-in-out overflow-y-auto ${
      ...
      <div className="p-4">
        ...
        <div className="space-y-6">
          {projects.map((project) => (
            <div 
              key={project.id} 
              className="bg-chatgpt-hover rounded-lg p-4 space-y-3"
            >
